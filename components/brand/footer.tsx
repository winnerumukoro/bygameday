...
export function Footer() {
  return (
    <footer className="bg-ink text-ivory pt-20 pb-12 border-t border-ink/40">
      <div className="max-w-stadium mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="md:col-span-4 flex flex-col gap-3">
            ...
            <form className="flex flex-col sm:flex-row gap-2 mt-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="bg-ivory/10 border border-ivory/20 px-4 py-3 text-sm text-ivory placeholder:text-ivory/40 focus:outline-none focus:ring-2 focus:ring-gold min-h-[48px] rounded-none flex-grow"
                aria-label="Email address for updates"
              />
              <Button type="submit" variant="primary" size="default" className="whitespace-nowrap">
                Subscribe
              </Button>
            </form>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-ivory/50 font-body">
