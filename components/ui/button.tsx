...
const buttonVariants = cva(
  "inline-flex items-center justify-center font-headline uppercase text-sm tracking-wider transition-colors duration-150 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 rounded-none",
  {
    variants: {
      variant: {
